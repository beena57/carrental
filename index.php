...
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets/images/logo2.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="assets/images/logo2.png">
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="assets/images/logo2.png">
<link rel="apple-touch-icon-precomposed" href="assets/images/logo2.png">
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>No matter who you are, or where you are going, our Car will help every type of traveler not only find the trip that’s right for them, but get the best value every time.</p>
    </div>
    <div class="row"> 
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-car" aria-hidden="true"></i>110+</h2>
